...
route.route('api/v1/usuarios').get(async (req, res) => {
    const { status, response } = await getAllUsers();
    res.status(status).json(response);
});

route.route('api/v1/usuarios/:correo_user').get(async (req, res) => {
    const { correo_user } = req.params;
    const { status, response } = await getUserByEmail(correo_user);
    res.status(status).json(response);
});

route.route('api/v1/usuarios').post(async (req, res) => {
    const bodyUser = req.body;
    const { status, response } = await createUser(bodyUser);
    res.status(status).json(response);
});

route.route('api/v1/usuarios/:correo_user/login').post(async (req, res) => {
    const { correo_user } = req.params;
...
route.route('api/v1/usuarios/:correo_user').put(async (req, res) => {
    const { correo_user } = req.params;
    const bodyUser = req.body;
...
route.route('api/v1/usuarios/:correo_user/general').put(async (req, res) => {
    const { correo_user } = req.params;
    const bodyUser = req.body;
...
route.route('api/v1/usuarios/:correo_user/email').put(async (req, res) => {
    const { correo_user } = req.params;
...
route.route('api/v1/usuarios/:correo_user/password').put(async (req, res) => {
    const { correo_user } = req.params;
...
route.route('api/v1/usuarios/:correo_user/recovery').put(async (req, res) => {
    const { correo_user } = req.params;
    const { status, response } = await recoveryCount(correo_user);
    res.status(status).json(response);
});

route.route('api/v1/usuarios/:correo_user/status').put(async (req, res) => {
    const { correo_user } = req.params;
...
route.route('api/v1/usuarios/:correo_user').delete(async (req, res) => {
    const { correo_user } = req.params;
